...
class Processo(db.Model):
    ...
    # Um processo pode ter MÃ�RIOS devedores (se necessário no futuro)
    # ou nenhum. O devedor que aponta para este processo via processo_id.
    devedores = db.relationship('Devedor', back_populates='processo', lazy=True)
